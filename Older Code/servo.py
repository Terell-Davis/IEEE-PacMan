...
LaserRangeFinder = adafruit_vl53l0x.VL53L0X(busio.I2C(3, 2))  # Create i2c Laser Range Finder Object
...
def getLaser(): # Get Laser Distance 10 times a second (not really....)
	while True: # Infinite loop, foreva? Forevaeva? For EVA EVA?
		...
		LaserDistance = LaserRangeFinder.range  # Grab Laser Distance and set Variable equal to it
		print(LaserDistance)  # Print it (This can be commented out, is not necessary for functionality)
